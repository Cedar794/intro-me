  ...
  if (logo) {
    return (
      <img
        ...
        data-tool-brand={tool === 'Lark CLI' ? 'feishu' : undefined}
        data-tool-icon="true"
        src={logo}
      />
    )
